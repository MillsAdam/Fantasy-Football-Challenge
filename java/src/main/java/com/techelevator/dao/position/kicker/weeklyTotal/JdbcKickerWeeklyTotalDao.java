package com.techelevator.dao.position.kicker.weeklyTotal;
...
@Component
public class JdbcKickerWeeklyTotalDao implements KickerWeeklyTotalDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcKickerWeeklyTotalDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<KickerDto> getKickerWeeklyTotalStats(int searchWeek) {
    ...
    @Override
    public List<KickerDto> getKickerWeeklyTotalStatsByConference(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerWeeklyTotalStatsByTeam(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerWeeklyTotalStatsByName(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
