...
@Component
public class JdbcDefenseNext4ProjectedDao implements DefenseNext4ProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcDefenseNext4ProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    private static final String SELECT_SQL =
            ...
            "WHERE SeasonType = 1 " +
                "AND d.Week >= StartingWeek.Week " +
                "AND d.Week <= StartingWeek.Week + 3 ";
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStats(int searchWeek) {
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStatsByName(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
