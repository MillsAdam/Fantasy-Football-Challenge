package com.techelevator.dao.position.flexPlayer.regularSeason.seasonProjected;
...
public class JdbcFlexPlayerSeasonProjectedDao implements FlexPlayerSeasonProjectedDao {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByConference(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByTeam(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByName(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByPosition(String searchPosition) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
        try {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByPositionAndConference(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByPositionAndTeam(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerSeasonProjectedStatsByPositionAndName(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
