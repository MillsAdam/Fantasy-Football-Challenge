...
@Component
public class JdbcKickerNext4ProjectedDao implements KickerNext4ProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");
    int currentWeek = Integer.parseInt(System.getProperty("CURRENT_WEEK")) + 1;


    public JdbcKickerNext4ProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStats() {
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStatsByConference(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStatsByTeam(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStatsByName(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
