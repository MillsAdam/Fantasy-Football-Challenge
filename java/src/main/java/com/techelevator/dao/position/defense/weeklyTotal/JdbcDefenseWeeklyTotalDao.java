package com.techelevator.dao.position.defense.weeklyTotal;
...
public class JdbcDefenseWeeklyTotalDao implements DefenseWeeklyTotalDao {
    ...
    @Override
    public List<DefenseDto> getDefenseWeeklyTotalStats(int searchWeek) {
    ...
    @Override
    public List<DefenseDto> getDefenseWeeklyTotalStatsByConference(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseWeeklyTotalStatsByTeam(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseWeeklyTotalStatsByName(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
