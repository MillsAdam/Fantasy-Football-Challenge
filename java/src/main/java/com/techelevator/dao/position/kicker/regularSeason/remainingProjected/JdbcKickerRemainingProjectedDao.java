...
@Component
public class JdbcKickerRemainingProjectedDao implements KickerRemainingProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcKickerRemainingProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStats(int searchWeek) {
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStatsByName(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
