...
public class JdbcQuarterbackLast4AverageDao implements QuarterbackLast4AverageDao {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStats() {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStatsByConference(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStatsByAndTeam(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStatsByAndName(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
