package com.techelevator.dao.position.defense.regularSeason.seasonProjected;
...
@Component
public class JdbcDefenseSeasonProjectedDao implements DefenseSeasonProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcDefenseSeasonProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<DefenseDto> getDefenseSeasonProjectedStatsByConference(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseSeasonProjectedStatsByTeam(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseSeasonProjectedStatsByName(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
