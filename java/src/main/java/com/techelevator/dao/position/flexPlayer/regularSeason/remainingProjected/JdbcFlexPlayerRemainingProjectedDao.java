...
@Component
public class JdbcFlexPlayerRemainingProjectedDao implements FlexPlayerRemainingProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcFlexPlayerRemainingProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStats(int searchWeek) {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByName(int searchWeek, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPosition(int searchWeek, String searchPosition) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
        try {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPositionAndConference(int searchWeek, String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPositionAndTeam(int searchWeek, String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPositionAndName(int searchWeek, String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
