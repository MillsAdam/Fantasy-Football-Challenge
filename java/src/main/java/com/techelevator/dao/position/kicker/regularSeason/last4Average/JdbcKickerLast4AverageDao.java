...
public class JdbcKickerLast4AverageDao implements KickerLast4AverageDao{
    ...
    @Override
    public List<KickerDto> getKickerLast4AverageStats(int searchWeek) {
    ...
    @Override
    public List<KickerDto> getKickerLast4AverageStatsByConference(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerLast4AverageStatsByTeam(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerLast4AverageStatsByName(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
