...
public class JdbcKickerNext4ProjectedDao implements KickerNext4ProjectedDao {
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerNext4ProjectedStatsByName(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
