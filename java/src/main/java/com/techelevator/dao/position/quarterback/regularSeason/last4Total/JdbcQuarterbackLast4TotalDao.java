...
@Component
public class JdbcQuarterbackLast4TotalDao implements QuarterbackLast4TotalDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.00");


    public JdbcQuarterbackLast4TotalDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStats(int searchWeek) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStatsByAndConference(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStatsByTeam(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStatsByName(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
