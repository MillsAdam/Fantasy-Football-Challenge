...
public class JdbcQuarterbackLast4AverageDao implements QuarterbackLast4AverageDao {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStats(int searchWeek) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStatsByConference(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStatsByAndTeam(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4AverageStatsByAndName(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
