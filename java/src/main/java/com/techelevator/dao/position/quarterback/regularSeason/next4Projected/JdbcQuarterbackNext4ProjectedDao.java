...
@Component
public class JdbcQuarterbackNext4ProjectedDao implements QuarterbackNext4ProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcQuarterbackNext4ProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStats(int searchWeek) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
        try {
            SqlRowSet results = jdbcTemplate.queryForRowSet(SELECT_SQL + GROUP_SQL, searchWeek);
            while (results.next()) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStatsByName(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
