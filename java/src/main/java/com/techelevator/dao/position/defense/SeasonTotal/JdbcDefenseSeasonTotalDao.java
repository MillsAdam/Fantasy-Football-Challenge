package com.techelevator.dao.position.defense.SeasonTotal;
...
public class JdbcDefenseSeasonTotalDao implements DefenseSeasonTotalDao{
    ...
    @Override
    public List<DefenseDto> getDefenseSeasonTotalStatsByConference(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseSeasonTotalStatsByTeam(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseSeasonTotalStatsByName(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
