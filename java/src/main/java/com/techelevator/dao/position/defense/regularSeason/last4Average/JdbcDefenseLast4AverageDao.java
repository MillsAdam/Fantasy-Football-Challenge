...
@Component
public class JdbcDefenseLast4AverageDao implements DefenseLast4AverageDao{
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.00");



    public JdbcDefenseLast4AverageDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStats(int searchWeek) {
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStatsByConference(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStatsByTeam(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStatsByName(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
