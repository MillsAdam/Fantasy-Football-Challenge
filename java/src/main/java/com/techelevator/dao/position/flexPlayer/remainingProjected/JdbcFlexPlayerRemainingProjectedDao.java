...
public class JdbcFlexPlayerRemainingProjectedDao implements FlexPlayerRemainingProjectedDao {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStats() {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByConference(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByTeam(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByName(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPosition(String searchPosition) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
        try {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPositionAndConference(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPositionAndTeam(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerRemainingProjectedStatsByPositionAndName(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
