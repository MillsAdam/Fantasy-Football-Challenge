...
@Component
public class JdbcDefenseRemainingProjectedDao implements DefenseRemainingProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcDefenseRemainingProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStats(int searchWeek) {
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStatsByName(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
