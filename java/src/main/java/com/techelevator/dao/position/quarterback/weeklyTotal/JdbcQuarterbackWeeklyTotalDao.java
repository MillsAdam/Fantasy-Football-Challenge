package com.techelevator.dao.position.quarterback.weeklyTotal;
...
@Component
public class JdbcQuarterbackWeeklyTotalDao implements QuarterbackWeeklyTotalDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcQuarterbackWeeklyTotalDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackWeeklyTotalStats(int searchWeek) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackWeeklyTotalStatsByConference(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackWeeklyTotalStatsByTeam(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackWeeklyTotalStatsByName(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
