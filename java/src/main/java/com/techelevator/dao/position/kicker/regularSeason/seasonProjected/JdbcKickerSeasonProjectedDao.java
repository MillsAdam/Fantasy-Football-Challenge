package com.techelevator.dao.position.kicker.regularSeason.seasonProjected;
...
@Component
public class JdbcKickerSeasonProjectedDao implements KickerSeasonProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.00");


    public JdbcKickerSeasonProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<KickerDto> getKickerSeasonProjectedStatsByConference(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerSeasonProjectedStatsByTeam(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerSeasonProjectedStatsByName(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
