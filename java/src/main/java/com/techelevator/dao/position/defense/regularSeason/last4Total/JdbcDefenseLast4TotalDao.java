...
@Component
public class JdbcDefenseLast4TotalDao implements DefenseLast4TotalDao{
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.00");


    public JdbcDefenseLast4TotalDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStats(int searchWeek) {
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStatsByConference(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStatsByTeam(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStatsByName(int searchWeek, String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
