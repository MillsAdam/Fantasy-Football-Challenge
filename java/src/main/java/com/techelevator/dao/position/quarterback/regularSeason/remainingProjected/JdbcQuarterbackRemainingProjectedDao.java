...
public class JdbcQuarterbackRemainingProjectedDao implements QuarterbackRemainingProjectedDao {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackRemainingProjectedStats(int searchWeek) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackRemainingProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackRemainingProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackRemainingProjectedStatsByName(int searchWeek, String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
