...
const teamOptions = ['ari', 'atl', 'bal', 'buf', 'car', 'chi', 'cin', 'cle', 'dal', 'den', 'det', 'gb', 'hou', 'ind', 'jax', 'kc', 'lac', 'lar', 'lv', 'mia', 'min', 'ne', 'no', 'nyg', 'nyj', 'phi', 'pit', 'sea', 'sf', 'tb', 'ten', 'wsh'];
                ...
                <div className="search-container">
                    <form onSubmit={searchPlayerStats}>
                        ...
                        {(selectedInterval === 'weekly total' || selectedInterval === 'weekly projected') && (
                            <div>
                                <select className="stats-filter-select"
                                    value={selectedWeek} 
                            ...
                            <div>
                                {(selectedCategory === 'conf' || selectedCategory === 'team') ? (
                                    ...
                                    >
                                        ...
                                        {selectedCategory === 'team' && teamOptions.map((team) => (
                                            <option key={team} value={team}>{teamDisplayOptions[team]}</option>
                                        ))}
                                    </select>
                                ) : selectedCategory === 'name' ? (
                                    <input className="stats-filter-input" 
                                        type="text" 
                                        value={selectedFilter} 
                        ...
                        <div>
                            <button className="stats-button" type="submit" disabled={isLoading}>Search</button>
