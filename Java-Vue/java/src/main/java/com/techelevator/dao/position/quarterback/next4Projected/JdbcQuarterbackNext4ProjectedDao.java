...
public class JdbcQuarterbackNext4ProjectedDao implements QuarterbackNext4ProjectedDao {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStats() {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStatsByConference(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStatsByTeam(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackNext4ProjectedStatsByName(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
