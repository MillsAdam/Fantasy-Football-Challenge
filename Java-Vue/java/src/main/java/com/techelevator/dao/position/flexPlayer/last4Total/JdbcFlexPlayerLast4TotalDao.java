...
public class JdbcFlexPlayerLast4TotalDao implements FlexPlayerLast4TotalDao{
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStats() {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByConference(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByTeam(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByName(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByPosition(String searchPosition) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
        try {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByPositionAndConference(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByPositionAndTeam(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4TotalStatsByPositionAndName(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
