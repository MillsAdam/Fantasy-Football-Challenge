...
public class JdbcQuarterbackLast4TotalDao implements QuarterbackLast4TotalDao {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStats() {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStatsByAndConference(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStatsByTeam(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackLast4TotalStatsByName(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
