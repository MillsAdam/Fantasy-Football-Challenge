...
public class JdbcKickerRemainingProjectedDao implements KickerRemainingProjectedDao {
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStats() {
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStatsByConference(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStatsByTeam(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerRemainingProjectedStatsByName(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
