package com.techelevator.dao.position.kicker.weeklyProjected;
...
@Component
public class JdbcKickerWeeklyProjectedDao implements KickerWeeklyProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcKickerWeeklyProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<KickerDto> getKickerWeeklyProjectedStats(int searchWeek) {
    ...
    @Override
    public List<KickerDto> getKickerWeeklyProjectedStatsByConference(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getAKickerWeeklyProjectedStatsByTeam(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerWeeklyProjectedStatsByName(int searchWeek, String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
