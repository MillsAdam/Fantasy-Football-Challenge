...
public class JdbcDefenseLast4TotalDao implements DefenseLast4TotalDao{
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStats() {
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStatsByConference(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStatsByTeam(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4TotalStatsByName(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
