...
public class JdbcDefenseNext4ProjectedDao implements DefenseNext4ProjectedDao {
    ...
    private static final String SELECT_SQL =
            ...
            "FROM defense_proj AS d " +
            "JOIN teams AS t ON d.TeamID = t.TeamID " +
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStats() {
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStatsByConference(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStatsByTeam(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseNext4ProjectedStatsByName(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
