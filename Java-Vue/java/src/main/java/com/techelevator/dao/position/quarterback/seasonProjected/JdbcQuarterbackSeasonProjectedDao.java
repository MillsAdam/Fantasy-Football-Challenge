package com.techelevator.dao.position.quarterback.seasonProjected;
...
@Component
public class JdbcQuarterbackSeasonProjectedDao implements QuarterbackSeasonProjectedDao {
    private final JdbcTemplate jdbcTemplate;
    DecimalFormat decimalFormat = new DecimalFormat("#.0");


    public JdbcQuarterbackSeasonProjectedDao(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackSeasonProjectedStatsByConference(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackSeasonProjectedStatsByTeam(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
    ...
    @Override
    public List<QuarterbackDto> getQuarterbackSeasonProjectedStatsByName(String searchTerm) {
        List<QuarterbackDto> quarterbackDtoList = new ArrayList<>();
