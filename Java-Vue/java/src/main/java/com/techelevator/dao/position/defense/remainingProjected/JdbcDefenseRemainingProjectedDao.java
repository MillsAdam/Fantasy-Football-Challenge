...
public class JdbcDefenseRemainingProjectedDao implements DefenseRemainingProjectedDao {
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStats() {
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStatsByConference(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStatsByTeam(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseRemainingProjectedStatsByName(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
