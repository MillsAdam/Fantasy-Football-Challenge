...
public class JdbcDefenseLast4AverageDao implements DefenseLast4AverageDao{
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStats() {
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStatsByConference(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStatsByTeam(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
    ...
    @Override
    public List<DefenseDto> getDefenseLast4AverageStatsByName(String searchTerm) {
        List<DefenseDto> defenseDtoList = new ArrayList<>();
