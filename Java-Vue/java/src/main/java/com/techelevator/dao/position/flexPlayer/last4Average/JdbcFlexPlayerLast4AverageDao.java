...
public class JdbcFlexPlayerLast4AverageDao implements FlexPlayerLast4AverageDao{
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStats() {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByConference(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByTeam(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByName(String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByPosition(String searchPosition) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
        try {
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByPositionAndConference(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByPositionAndTeam(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
    ...
    @Override
    public List<FlexPlayerDto> getFlexPlayerLast4AverageStatsByPositionAndName(String searchPosition, String searchTerm) {
        List<FlexPlayerDto> flexPlayerDtoList = new ArrayList<>();
