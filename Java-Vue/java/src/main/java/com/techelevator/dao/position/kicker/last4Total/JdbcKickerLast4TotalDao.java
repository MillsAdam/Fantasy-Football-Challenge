...
public class JdbcKickerLast4TotalDao implements KickerLast4TotalDao{
    ...
    @Override
    public List<KickerDto> getKickerLast4TotalStats() {
    ...
    @Override
    public List<KickerDto> getKickerLast4TotalStatsByConference(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerLast4TotalStatsByTeam(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
    ...
    @Override
    public List<KickerDto> getKickerLast4TotalStatsByName(String searchTerm) {
        List<KickerDto> kickerDtoList = new ArrayList<>();
